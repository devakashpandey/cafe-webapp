...
export function Footer() {
    return (
        <footer className="pt-16 md:pt-20 pb-8 md:pb-12 bg-background text-foreground relative overflow-hidden border-t border-border">
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-16 mb-12 md:mb-20">
                    <div className="flex flex-col gap-6 md:gap-8 col-span-1 lg:col-span-2">
                        ...
                        <p className="text-muted-foreground text-sm md:text-base max-w-sm font-medium leading-relaxed">
                        ...
                        <div className="flex gap-3 md:gap-4">
                            {[
                                ...
                                <Button
                                    ...
                                    variant="outline"
                                    size="icon"
                                    className="w-10 h-10 md:w-12 md:h-12 rounded-xl border-border bg-secondary/50 hover:bg-primary hover:border-primary text-foreground hover:text-white group transition-all h-auto"
                                >
                    ...
                    <div className="flex flex-col gap-4 md:gap-6">
                        ...
                        <div className="flex flex-col gap-3">
                            <Input placeholder="Your best email address" className="h-12 md:h-14 rounded-xl bg-secondary border-border text-foreground placeholder:text-muted-foreground px-5 font-bold text-sm" />
                            <Button className="h-12 md:h-14 font-black uppercase tracking-[0.2em] rounded-xl shadow-xl shadow-primary/20 text-xs text-white">Subscribe Now</Button>
                        </div>
                    </div>
                </div>
